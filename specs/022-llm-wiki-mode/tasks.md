...
- [X] T005 Run `pnpm db:generate` to produce migration `0022_*`, verify a second run reports "No schema changes", and confirm boot migration applies cleanly via `docker compose up -d --build`
