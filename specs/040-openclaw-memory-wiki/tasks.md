...
- [X] T022 [US1] Implement the content-free mirror-key connection capability route in `apps/web/app/api/v1/memory/wiki/connection/route.ts` using the mirror-purpose guard and Agent Memory version gate.
