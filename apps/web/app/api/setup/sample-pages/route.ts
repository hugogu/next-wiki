 ...
 * @description Generates the optional welcome, Markdown syntax, main features, and Agent memory guide pages as normal published wiki pages (idempotent, collision-safe), or records the skip choice. Requires the signed-in initial Admin.
 * @tag Setup
 * @auth bearer
