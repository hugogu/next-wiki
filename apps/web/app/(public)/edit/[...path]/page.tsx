  ...
  return (
    <Layout pageContext={pageContext} fitViewport space={space}>
      <div className="h-full flex flex-col">
        <EditPageForm path={path} space={space} initial={{ pageId: view.pageId, revisionId: view.revisionId, slug: view.slug, title: view.title, contentSource: view.contentSource, canPublish: view.canPublish, canDelete: view.canDelete, latestVersion: view.latestVersion, metadata: view.metadata, visibility: view.visibility, canSetVisibility: actor.kind === 'user' && actor.role === 'admin', writeMetadataToFrontmatter: view.writeMetadataToFrontmatter }} />
      </div>
    </Layout>
  );
}
