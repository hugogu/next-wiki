...
export function mapPublicDomainErrorCode(code: DomainError['code']): { code: PublicApiErrorCode; status: number } {
  switch (code) {
    ...
    case 'HERMES_MEMORY_SCOPE_REQUIRED':
      return { code: 'HERMES_MEMORY_SCOPE_REQUIRED', status: 403 };
    case 'HERMES_MEMORY_KEY_UNBOUND':
      return { code: 'HERMES_MEMORY_KEY_UNBOUND', status: 403 };
    case 'HERMES_MEMORY_NAMESPACE_UNAVAILABLE':
      return { code: 'HERMES_MEMORY_NAMESPACE_UNAVAILABLE', status: 403 };
    case 'HERMES_MEMORY_RECORD_NOT_FOUND':
      return { code: 'HERMES_MEMORY_RECORD_NOT_FOUND', status: 404 };
    case 'HERMES_MEMORY_EVIDENCE_INVALID':
      return { code: 'HERMES_MEMORY_EVIDENCE_INVALID', status: 422 };
    case 'HERMES_MEMORY_CHECKPOINT_NOT_DURABLE':
      return { code: 'HERMES_MEMORY_CHECKPOINT_NOT_DURABLE', status: 409 };
    case 'HERMES_MEMORY_INCOMPATIBLE_CLIENT':
      return { code: 'HERMES_MEMORY_INCOMPATIBLE_CLIENT', status: 426 };
    default:
