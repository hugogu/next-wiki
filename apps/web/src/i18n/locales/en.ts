export const en = {
  ...
  'admin.ai.providers.modelDiscovery': 'Model discovery',
  ...
  'admin.ai.providerType.chat': 'Chat Provider',
  'admin.ai.providerType.embedding': 'Embedding Provider',
  'admin.ai.providerType.image': 'Image Provider',
  ...
  'admin.ai.providerProtocol.openaiCompatible': 'OpenAI compatible',
  ...
  'admin.ai.providerProtocol.minimax': 'MiniMax Image',
  'admin.ai.modelDiscovery.openai': 'OpenAI-compatible /models',
  'admin.ai.modelDiscovery.openrouter': 'OpenRouter model catalog',
  'admin.ai.modelDiscovery.anthropic': 'Anthropic /models',
  'admin.ai.modelDiscovery.none': 'Manual models',
  ...
  'admin.ai.assignments.title': 'System AI functions',
  'admin.ai.assignments.description': 'Choose the model used by each system function. Embeddings and image generation use their dedicated provider APIs, not the Chat API.',
