export const en = {
  ...
  'admin.storage.git.description':
    'One-way export of published Markdown and referenced images. Git is never used as a read source.',
  'admin.storage.git.enabled': 'Git export enabled',
  'admin.storage.git.enabledDescription':
    'Publish changes asynchronously to the configured system-owned branch.',
  'admin.storage.git.remoteUrl': 'Remote URL',
  'admin.storage.git.branch': 'Export branch',
  ...
  'admin.storage.git.saved': 'Git export configuration saved.',
  'admin.storage.git.exportNow': 'Export now',
  'admin.storage.git.exportQueued': 'Full Git export queued.',
  'admin.storage.git.enableTitle': 'Enable Git export?',
  'admin.storage.git.enableMessage':
    'The current published state will be exported immediately. Future publish, delete, and path changes will enqueue another reconciliation.',
  'admin.storage.git.enableAndExport': 'Enable and export',
