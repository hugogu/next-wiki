export const en = {
  ...
  'admin.tags.newPlaceholder': 'New tag',
  'admin.tags.create': 'Create',
  'admin.tags.created': 'Tag created.',
  'admin.tags.rename': 'Rename',
  'admin.tags.renamePrompt': 'New tag name',
  'admin.tags.delete': 'Delete',
  'admin.tags.operation': 'Tag operation {{status}}. Refresh after the operation completes.',
