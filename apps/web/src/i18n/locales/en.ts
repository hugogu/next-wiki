export const en = {
  ...
  'admin.appearance.preview.danger': 'Danger',
  'admin.appearance.preview.warning': 'Warning',
  ...
  'userCenter.readingTheme.title': 'Markdown reading theme',
  'userCenter.readingTheme.description':
    'Choose how Markdown content is rendered for you. Built-in themes are read-only — copy one to customize. Colors always follow the system theme.',
  'userCenter.readingTheme.builtin': 'built-in',
  'userCenter.readingTheme.builtinReadonly': 'Built-in themes are read-only.',
  'userCenter.readingTheme.active': 'Active',
  'userCenter.readingTheme.activate': 'Activate',
  'userCenter.readingTheme.activated': 'Theme activated.',
  'userCenter.readingTheme.copy': 'Copy to edit',
  'userCenter.readingTheme.copied': 'Copy created.',
  'userCenter.readingTheme.save': 'Save',
  'userCenter.readingTheme.saved': 'Theme saved.',
  'userCenter.readingTheme.delete': 'Delete',
  'userCenter.readingTheme.deleted': 'Theme deleted.',
  'userCenter.readingTheme.selectHint': 'Select a theme to view or edit its stylesheet.',
  'userCenter.readingTheme.nameLabel': 'Theme name',
  'userCenter.readingTheme.cssLabel': 'Theme stylesheet',
  'userCenter.readingTheme.error.generic': 'Something went wrong. Please try again.',
