export const en = {
  ...
  'editor.properties.fields.dateLabel': 'Date',
  'editor.properties.fields.tagsLabel': 'Tags',
  ...
  'admin.tags.heading': 'Tags',
  'admin.tags.ariaLabel': 'Tag management',
  'admin.tags.createHeading': 'Create a tag',
  'admin.tags.createDescription': 'New tags join the global registry and can be used in any page metadata.',
  'admin.tags.newPlaceholder': 'Enter a tag name',
  'admin.tags.create': 'Create tag',
  'admin.tags.created': 'Tag created.',
  'admin.tags.rename': 'Rename',
  'admin.tags.renamed': 'Tag renamed and synchronized across {{count}} pages.',
  'admin.tags.renameTitle': 'Rename tag',
  'admin.tags.renameDescription': 'Change the name of “{{name}}”. Pages using it will be synchronized automatically.',
  'admin.tags.nameLabel': 'Tag name',
  'admin.tags.merge': 'Merge',
  'admin.tags.merged': 'Tags merged and synchronized across {{count}} pages.',
  'admin.tags.mergeTitle': 'Merge tag',
  'admin.tags.mergeDescription': 'Move every page associated with “{{name}}” to another tag.',
  'admin.tags.mergeTarget': 'Destination tag',
  'admin.tags.mergeWarning': 'The source tag is removed after the merge. Pages using both tags keep only the destination tag.',
  'admin.tags.mergeConfirm': 'Merge tags',
  'admin.tags.delete': 'Delete',
  'admin.tags.deleted': 'Tag deleted and removed from {{count}} pages.',
  'admin.tags.deleteTitle': 'Delete tag?',
  'admin.tags.deleteDescription': 'Delete “{{name}}” and remove it from {{count}} related pages. This creates new page revisions.',
  'admin.tags.searchPlaceholder': 'Search tags',
  'admin.tags.tagCount': '{{count}} tags',
  ...
  'admin.tags.pagesLoadFailed': 'Unable to load related pages',
  'admin.tags.operationQueued': 'The operation is queued and related pages are being synchronized.',
  'admin.tags.operationPending': 'The operation is still running in the background. Its latest state will appear shortly.',
  'admin.tags.loadFailed': 'Unable to load tags',
  'admin.tags.createFailed': 'Unable to create tag',
  'admin.tags.updateFailed': 'Unable to update tag',
  ...
  'layout.nav.addChild': 'New page here',
  ...
  'admin.searchSettings.semantic.title': 'Vector search',
  'admin.searchSettings.semantic.description': 'When enabled, header search blends keyword matches with semantic vector results. Disable it for keyword-only search.',
  'admin.searchSettings.minRelevance.label': 'Minimum relevance score',
  'admin.searchSettings.minRelevance.help': 'Only show results whose keyword or vector relevance score is at least this value. Use 0 for permissive matching; try 0.65+ to hide weak vector matches.',
  'admin.searchSettings.excerpts.title': 'Result descriptions',
  'admin.searchSettings.excerpts.description': 'Show a short excerpt under each search result.',
  'admin.searchSettings.excerptLength.label': 'Description length',
  'admin.searchSettings.excerptLength.help': 'Approximate character count for each result description. Valid range: 20–500.',
  'admin.searchSettings.saved': 'Saved.',
  'admin.searchSettings.saveError': 'Failed to save search settings.',
  ...
  'admin.pages.filters.keyword': 'Search',
  'admin.pages.filters.keywordPlaceholder': 'Title, author, or path',
  ...
  'admin.pages.status.deleted': 'Deleted',
  'admin.pages.actions.view': 'View page',
  'admin.pages.actions.edit': 'Edit page',
  'admin.pages.actions.history': 'View history',
  'admin.pages.actions.properties': 'Page properties',
  ...
  'admin.transfers.wikijs.testing': 'Testing connection…',
  'admin.transfers.wikijs.testSuccess': 'Connection OK',
  'admin.transfers.wikijs.testFailed': 'Connection failed',
  ...
  'admin.transfers.detail.filter.failed': 'Errors',
  ...
  'admin.transfers.status.paused': 'Paused',
  ...
  'admin.transfers.actions.cleanup': 'Clean up',
  ...
  'admin.ai.modelDetector.registerProviders': 'Register OpenRouter providers for all capabilities',
  'admin.ai.modelDetector.registerProvidersHint': 'Create chat, embedding, and image providers from this key. Each is registered under a distinct name.',
  ...
  'admin.ai.actions.table.tokens': 'Token usage',
  ...
  'translation.admin.documents': 'Translated documents',
  'translation.admin.usage': 'Usage & cost',
  'translation.language.add': 'Add language',
  'translation.language.code': 'Language code',
  'translation.language.enabled': 'Enabled',
  'translation.language.retired': 'Retired',
  'translation.language.defaultModel': 'Default model',
  'translation.language.defaultStyle': 'Default style',
  'translation.style.add': 'Add style',
  'translation.style.name': 'Name',
  'translation.style.body': 'Instructions',
  'translation.style.version': 'Version {{n}}',
  'translation.run.create': 'Start translation',
  'translation.run.targetLocale': 'Target language',
  'translation.run.model': 'Model',
  'translation.run.style': 'Style',
  'translation.run.scope': 'Scope',
  'translation.run.scope.allPublished': 'All published pages',
  'translation.run.mode': 'Mode',
  'translation.run.mode.missing': 'Only missing translations',
  'translation.run.mode.all': 'Retranslate all',
  'translation.run.pause': 'Pause',
  'translation.run.resume': 'Resume',
  'translation.run.cancel': 'Cancel',
  'translation.run.retry': 'Retry / replace',
  'translation.run.progress': '{{processed}} / {{total}}',
  'translation.status.queued': 'Queued',
  'translation.status.running': 'Running',
  'translation.status.paused': 'Paused',
  'translation.status.completed': 'Completed',
  'translation.status.completed_with_warnings': 'Completed with warnings',
  'translation.status.failed': 'Failed',
  'translation.status.cancelled': 'Cancelled',
  'translation.item.pending': 'Pending',
  'translation.item.running': 'Running',
  'translation.item.completed': 'Completed',
  'translation.item.skipped': 'Skipped',
  'translation.item.failed': 'Failed',
  'translation.item.cancelled': 'Cancelled',
  'translation.item.superseded': 'Superseded',
  'translation.language.none': 'None',
  'translation.language.empty': 'No target languages configured yet.',
  'translation.language.enable': 'Enable',
  'translation.language.disable': 'Disable',
  'translation.language.retire': 'Retire',
  'translation.style.newVersion': 'New version',
  'translation.style.empty': 'No translation styles yet.',
  'translation.run.modelDefault': 'Use language default',
  'translation.run.empty': 'No translation runs yet.',
  'translation.run.detail.items': 'Pages',
  'translation.run.detail.history': 'History',
  'translation.document.source': 'Source page',
  'translation.document.freshness': 'Freshness',
  'translation.document.open': 'Open',
  ...
  'translation.freshness.running': 'Refreshing',
  'translation.freshness.failed': 'Refresh failed',
  'translation.freshness.unavailable': 'Unavailable',
  'translation.usage.reported': 'Reported',
  'translation.usage.estimated': 'Estimated',
  'translation.usage.unavailable': 'Unavailable',
  'translation.usage.duration': 'Duration',
  'translation.reader.unavailable.title': 'Translation unavailable',
  'translation.reader.unavailable.body': 'This page has not been translated into this language yet.',
  'translation.reader.inProgress.body': 'A translation is being prepared. Please check back soon.',
  'translation.error.INVALID_TRANSLATION_INPUT': 'The translation request is invalid.',
  'translation.error.TRANSLATION_NOT_FOUND': 'The translation could not be found.',
  'translation.error.TRANSLATION_ALREADY_RUNNING': 'This language already has an active run.',
  'translation.error.RUN_NOT_ACTIVE': 'The run is not active.',
  'translation.error.RUN_NOT_PAUSED': 'The run is not paused.',
  'translation.error.MODEL_UNAVAILABLE': 'The selected model is unavailable.',
  'translation.error.CAPABILITY_MISMATCH': 'The selected model cannot generate text.',
  'translation.error.SOURCE_NOT_TRANSLATABLE': 'The selected page has no eligible published source.',
  'translation.error.AI_DISABLED': 'AI features are disabled.',
  'translation.error.JOB_QUEUE_UNAVAILABLE': 'Background work is unavailable right now.',
