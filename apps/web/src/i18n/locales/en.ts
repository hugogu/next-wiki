export const en = {
  ...
  'admin.ai.modelDetector.description': 'OpenRouter API key used to detect model capabilities (vision, thinking, etc.) during model sync. Optional but recommended for accurate catalog enrichment.',
