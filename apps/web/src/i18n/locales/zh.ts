...
export const zh: Translations = {
  ...
  'admin.storage.git.description': '单向导出已发布的 Markdown 和引用图片。Git 不会作为读取源。',
  'admin.storage.git.enabled': '启用 Git 导出',
  'admin.storage.git.enabledDescription': '异步发布到配置的系统专用分支。',
  'admin.storage.git.remoteUrl': '远程仓库 URL',
  'admin.storage.git.branch': '导出分支',
  ...
  'admin.storage.git.sshMissing': '请先生成密钥，再把公钥配置到远程仓库，然后启用导出。',
  'admin.storage.git.keyGenerated': 'SSH Key 已生成，请将公钥配置到远程 Git 仓库。',
  'admin.storage.git.saved': 'Git 导出配置已保存。',
  'admin.storage.git.exportNow': '立即导出',
  'admin.storage.git.exportQueued': '已加入全量 Git 导出队列。',
  'admin.storage.git.enableTitle': '启用 Git 导出？',
  'admin.storage.git.enableMessage':
    '系统会立即全量导出当前已发布内容。后续发布、删除和路径修改会再次触发协调。',
  'admin.storage.git.enableAndExport': '启用并导出',
